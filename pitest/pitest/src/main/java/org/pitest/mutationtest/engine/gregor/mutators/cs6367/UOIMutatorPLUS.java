...
public enum UOIMutatorPLUS implements MethodMutatorFactory {
  ...
  public MethodVisitor create(final MutationContext context,
    ...
    return new UOIMutatorPLUSMethodVisitor(this, context, methodVisitor);
  }
...
class UOIMutatorPLUSMethodVisitor extends MethodVisitor {

  private final MethodMutatorFactory factory;
  private final MutationContext      context;

  UOIMutatorPLUSMethodVisitor(final MethodMutatorFactory factory,
