...
public class CRCRMutatorWITHZERO implements MethodMutatorFactory {

  private final class CRCRMutatorWITHZEROVisitor extends MethodVisitor {
    private final MutationContext context;

    CRCRMutatorWITHZEROVisitor(final MutationContext context,
    ...
    private <T extends Number> boolean shouldMutate(final T constant,
      ...
      final MutationIdentifier mutationId = this.context.registerMutation(
              CRCRMutatorWITHZERO.this, "Substituted " + constant + " with "
                      + replacement);
  ...
  public MethodVisitor create(final MutationContext context,
    ...
    return new CRCRMutatorWITHZEROVisitor(context, methodVisitor);
  }
