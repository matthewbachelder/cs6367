...
public class CRCRMutatorNEGATE implements MethodMutatorFactory {

  private final class CRCRMutatorNEGATEMutatorVisitor extends MethodVisitor {
    private final MutationContext context;

    CRCRMutatorNEGATEMutatorVisitor(final MutationContext context,
    ...
    private <T extends Number> boolean shouldMutate(final T constant,
      ...
      final MutationIdentifier mutationId = this.context.registerMutation(
              CRCRMutatorNEGATE.this, "Substituted " + constant + " with "
                      + replacement);
  ...
  public MethodVisitor create(final MutationContext context,
    ...
    return new CRCRMutatorNEGATEMutatorVisitor(context, methodVisitor);
  }
