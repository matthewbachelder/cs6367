...
public class CRCRMutatorWITHONE implements MethodMutatorFactory {

  private final class CRCRMutatorWITHONEVisitor extends MethodVisitor {
    private final MutationContext context;

    CRCRMutatorWITHONEVisitor(final MutationContext context,
    ...
    private <T extends Number> boolean shouldMutate(final T constant,
      ...
      final MutationIdentifier mutationId = this.context.registerMutation(
              CRCRMutatorWITHONE.this, "Substituted " + constant + " with "
                      + replacement);
  ...
  public MethodVisitor create(final MutationContext context,
    ...
    return new CRCRMutatorWITHONEVisitor(context, methodVisitor);
  }
