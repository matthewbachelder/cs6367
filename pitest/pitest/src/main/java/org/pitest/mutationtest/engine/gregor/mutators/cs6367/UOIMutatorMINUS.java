...
public enum UOIMutatorMINUS implements MethodMutatorFactory {
  ...
  public MethodVisitor create(final MutationContext context,
    ...
    return new UOIMutatorMinusMethodVisitor(this, context, methodVisitor);
  }
...
class UOIMutatorMinusMethodVisitor extends MethodVisitor {

  private final MethodMutatorFactory factory;
  private final MutationContext      context;

  UOIMutatorMinusMethodVisitor(final MethodMutatorFactory factory,
