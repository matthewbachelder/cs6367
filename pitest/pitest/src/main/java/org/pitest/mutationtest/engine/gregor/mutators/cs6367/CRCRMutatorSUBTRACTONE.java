...
public class CRCRMutatorSUBTRACTONE implements MethodMutatorFactory {

  private final class CRCRMutatorSUBTRACTONEVisitor extends MethodVisitor {
    private final MutationContext context;

    CRCRMutatorSUBTRACTONEVisitor(final MutationContext context,
    ...
    private <T extends Number> boolean shouldMutate(final T constant,
      ...
      final MutationIdentifier mutationId = this.context.registerMutation(
              CRCRMutatorSUBTRACTONE.this, "Substituted " + constant + " with "
                      + replacement);
  ...
  public MethodVisitor create(final MutationContext context,
    ...
    return new CRCRMutatorSUBTRACTONEVisitor(context, methodVisitor);
  }
